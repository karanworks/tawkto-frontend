                    ...
                    {item.icon &&
                      (item.subItems ? (
                        <li>
                          ...
                          {item.menuLableId === "LiveConversations" &&
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span style={{ fontSize: "13px" }}>New Chat Request</span>
                      <span style={{ fontSize: "14px" }}>Someone</span>
                    </div>
                  </div>
                  ...
                  >
                    <button
                      ...
                      // onMouseOver={(e) => (
                      //   (e.target.style.backgroundColor = "#25A0E2"),
                      //   (e.target.style.color = "white")
                      // )}
                      // onMouseOut={(e) => (
                      //   (e.target.style.backgroundColor = "white"),
                      //   (e.target.style.color = "#25A0E2")
                      // )}
                    >
                    ...
                    >
                      <span className="icon-on">
                        <i className="ri-spam-3-line align-bottom me-1"></i>{" "}
                        Ignore
                      </span>
                    </button>
                  </div>
